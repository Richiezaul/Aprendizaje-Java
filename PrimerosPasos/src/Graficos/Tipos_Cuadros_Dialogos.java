	...
	private class Accion_botones implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			///	System.out.println("Has pulsado el botón 1");
				...
				JOptionPane.showMessageDialog(Lamina_Cuadros_Dialogos.this,"Prueba Mesaje","Error",2);
				...
				JOptionPane.showInputDialog(Lamina_Cuadros_Dialogos.this,"introduce un valor","Nombre",1);
			...
			//	System.out.println("Has pulsado el botón 3");
				...
				JOptionPane.showConfirmDialog(Lamina_Cuadros_Dialogos.this, "elige option", "V confirmar", 2);
				...
				JOptionPane.showOptionDialog(Lamina_Cuadros_Dialogos.this, "Elige", "V Optiones", 1, 1, null, null, null);
